    ...
    <div className="min-h-screen bg-white-900 font-semibold flex justify-center items-center px-6 py-12">
      <div className="max-w-4xl w-full">
        ...
        <div className="text-left">
          ...
          <ul className="text-lg text-gray-500 dark:text-gray-400 list-disc list-inside space-y-2 mb-12">
          ...
          <ul className="text-lg text-gray-500 dark:text-gray-400 list-disc list-inside space-y-2">
